...
class Individual(object):
    ...
    def Mating(self, Parents):
        ...
        for Parent_1, Parent_2 in zip(self.chromosome, Parents.chromosome):
            ...
            if Probability < 0.45: # Nếu xác suất nhỏ hơn 0.45 thì chèn gen của Parent_1
                Child_Chromosome.append(Parent_1)
            elif Probability < 0.90: # Nếu xác suất nằm trong khoảng từ 0.45 - 0.90 thì chèn gen của Parent_2
